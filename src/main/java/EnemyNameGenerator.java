...
public class EnemyNameGenerator {
    ...
    private static String getRandomBossTitle() {
        Random rand = new Random();
        String[] bossTitles = {" The Crusher", ", MegaBot", " The Circuit-Breaker", " The Destroyer", ", Giga-Chad",
            ", Maniacal Mainframe", ", Supreme Techno-Giant", ", Fearsome Dragon-Bot", " The Cyber-Ruin",
            ", Unrivalled Neuro-Network", " The De-Compiler"};
